 ...
 * @author Yudha
 */
public class KaryaTulisFrame extends javax.swing.JFrame {

    /**
     * Creates new form KaryaTulisFrame
     */
    public KaryaTulisFrame() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(KaryaTulisFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new KaryaTulisFrame().setVisible(true);
            }
        });
    }
